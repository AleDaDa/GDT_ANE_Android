...
public class AneFunctions {
	...
	public static final String VIDEO_CREATE	= "createRewardVideo";
	public static final String VIDEO_SHOW	= "showRewardVideo";
	public static final String VIDEO_CACHE	= "isInterstitialLoaded";
	public static final String VIDEO_REMOVE	= "removeRewardVideo";
	public static final String VIDEO_IS_LOADED	= "isRewardVideoLoaded";
